...
<div class="row">
<div id="teste1" class="container-fluid col-md-2">
    ...
    <h3>Menu</h3>
        ...
        <li class="nav-item">
            <a id="products" class="nav-link" href="?controller=site&action=products">Produtos e Serviços</a>
        </li>
        <li class="nav-item">
...
<div id="teste1" class="container-fluid col-md-8">
